...
XMVECTOR XM_CALLCONV MyXMVectorRound(FXMVECTOR V) noexcept
{
    ...
    return vResult;
#else
	return _mm_cvtepi32_ps(_mm_cvtps_epi32(V));						// <--- 1ied by shinjich for testing
#endif
#endif
}

XMVECTOR XM_CALLCONV MyXMVectorModAngles(FXMVECTOR Angles) noexcept
{
#if defined(_XM_NO_INTRINSICS_)
...
void XM_CALLCONV MyXMVectorSinCos
(
    XMVECTOR* pSin,
    XMVECTOR* pCos,
    FXMVECTOR V
