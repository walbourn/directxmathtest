...
bool FFT4Test()
{
    ...
    XM_ALIGNED_DATA(16) XVEC rinput[] = { { { { 1.f, 2.f, 3.f, 4.f } } }, };
    XM_ALIGNED_DATA(16) XVEC iinput[] = { { { { 5.f, 6.f, 7.f, 8.f } } }, };

    FFT4( reinterpret_cast<XMVECTOR*>(rinput), reinterpret_cast<XMVECTOR*>(iinput), 1 );

    static const XM_ALIGNED_DATA(16) XVEC ranswer[] = { { { { 10.f, -4.f, -2.f, 0.f } } } };
    static const XM_ALIGNED_DATA(16) XVEC ianswer[] = { { { { 26.f, 0.f, -2.f, -4.f } } } };
...
bool FFT8Test()
{
    ...
    XM_ALIGNED_DATA(16) XVEC rinput[] = { { { { 1.f, 2.f, 3.f, 4.f } } }, { { { 5.f, 6.f, 7.f, 8.f } } } };
    XM_ALIGNED_DATA(16) XVEC iinput[] = { { { { 9.f, 10.f, 11.f, 12.f } } }, { { { 13.f, 14.f, 15.f, 16.f } } } };

    FFT8(reinterpret_cast<XMVECTOR*>(rinput), reinterpret_cast<XMVECTOR*>(iinput), 1 );

    static const XM_ALIGNED_DATA(16) XVEC ranswer[] = { { { { 36.f, -13.656855f, -8.f, -5.656854f } } }, { { { -4.f, -2.343146f, 0.f, 5.656854f } } } };
    static const XM_ALIGNED_DATA(16) XVEC ianswer[] = { { { { 100.f, 5.656854f, 0.f, -2.343146f } } }, { { { -4.f, -5.656854f, -8.f, -13.656855f } } } };
...
bool FFT16Test()
{
    ...
    XM_ALIGNED_DATA(16) XVEC rinput[] = { { { { 1.f, 2.f, 3.f, 4.f } } }, { { { 5.f, 6.f, 7.f, 8.f } } }, { { { 9.f, 10.f, 11.f, 12.f } } }, { { { 13.f, 14.f, 15.f, 16.f } } } };
    XM_ALIGNED_DATA(16) XVEC iinput[] = { { { { 1.1f, 2.1f, 3.1f, 4.1f } } }, { { { 5.1f, 6.1f, 7.1f, 8.1f } } }, { { { 9.1f, 10.1f, 11.1f, 12.1f } } }, { { { 13.1f, 14.1f, 15.1f, 16.1f } } } };

    FFT16( reinterpret_cast<XMVECTOR*>(rinput), reinterpret_cast<XMVECTOR*>(iinput), 1 );

    static const XM_ALIGNED_DATA(16) XVEC ranswer[] = {
        { { { 136.f, -16.f, -8.f, 0.f } } },
        { { { -48.218716f, -13.345429f, -6.408703f, 3.972846f } } },
        { { { -27.313709f, -11.313709f, -4.686292f, 11.313707f } } },
        { { { -19.972847f, -9.591298f, -2.654571f, 32.218716f } } }
    };
    static const XM_ALIGNED_DATA(16) XVEC ianswer[] = {
        { { { 137.600006f, 0.f, -8.f, -16.f } } },
        { { { 32.218716f, -2.654571f, -9.591298f, -19.972847f } } },
        { { { 11.313708f, -4.686292f, -11.313708f, -27.313709f } } },
        { { { 3.972846f, -6.408703f, -13.345429f, -48.218716f } } }
    };
...
bool FFTTest()
{
    ...
    XM_ALIGNED_DATA(16) XVEC iinput[] = { { { { 1.2f, 2.2f, 3.2f, 4.2f } } }, { { { 5.2f, 6.2f, 7.2f, 8.2f } } }, { { { 9.2f, 10.2f, 11.2f, 12.2f } } }, { { { 13.2f, 14.2f, 15.2f, 16.2f } } },
    ...
    static const XM_ALIGNED_DATA(16) XVEC ranswer[] = {
        { { { 273.599976f, -54.627419f, -32.f, -22.627415f } } }, { { { -15.999985f, -9.372581f, 0.f, 22.627415f } } },
    ...
    static const XM_ALIGNED_DATA(16) XVEC ianswer[] = {
        { { { 280.f, 22.627415f, -0.000008f, -9.372585f } } }, { { { -16.f, -22.627415f, -31.999992f, -54.627415f } } },
...
//--------------------------------------------------------------------------------------
bool FFTUnswizzleTest()
{
    using namespace XDSP;

    static const XM_ALIGNED_DATA(16) XVEC input[] = { { { { 0.f, 1.f, 2.f, 3.f } } },{ { { 4.f, 5.f, 6.f, 7.f } } },{ { { 8.f , 9.f, 10.f, 11.f } } },{ { { 12.f, 13.f, 14.f, 15.f } } } };
    ...
    static const XM_ALIGNED_DATA(16) XVEC answer[] = {
        { { { 0.f, 4.f, 8.f, 12.f } } },
        { { { 1.f, 5.f, 9.f, 13.f } } },
        { { { 2.f, 6.f, 10.f, 14.f } } },
        { { { 3.f, 7.f, 11.f, 15.f } } }
...
bool FFTPolarTest()
{
    ...
    static const XM_ALIGNED_DATA(16) XVEC answer[] = {
        { { { 0.097628f, 0.185826f, 0.274146f, 0.362500f } } }, { { { 0.450867f, 0.539241f, 0.627620f, 0.716000f } } },
...
//--------------------------------------------------------------------------------------
bool DeinterleaveTest()
{
    using namespace XDSP;

    static const XM_ALIGNED_DATA(16) XVEC input[] = { { { { 1.f, 2.f, 3.f, 4.f } } }, { { { 5.f, 6.f, 7.f, 8.f } } }, { { { 9.f, 10.f, 11.f, 12.f } } }, { { { 13.f, 14.f, 15.f, 16.f } } },
                                  { { { 1.1f, 2.1f, 3.1f, 4.1f } } }, { { { 5.1f, 6.1f, 7.1f, 8.1f } } }, { { { 9.1f, 10.1f, 11.1f, 12.1f } } }, { { { 13.1f, 14.1f, 15.1f, 16.1f } } } };
    ...
    static const XM_ALIGNED_DATA(16) XVEC answer[] = {
        { { { 1.f, 3.f, 5.f, 7.f } } }, { { { 9.f, 11.f, 13.f, 15.f } } }, { { { 1.1f, 3.1f, 5.1f, 7.1f } } }, { { { 9.1f, 11.1f, 13.1f, 15.1f } } },
...
bool InterleaveTest()
{
    ...
    static const XM_ALIGNED_DATA(16) XVEC answer[] =
    {
        { { { 1.f, 1.1f, 2.f, 2.1f } } }, { { { 3.f, 3.1f, 4.f, 4.1f } } }, { { { 5.f, 5.1f, 6.f, 6.1f } } }, { { { 7.f, 7.1f, 8.f, 8.1f } } },
...
bool FFTInterleavedTest()
{
    ...
    XM_ALIGNED_DATA(16) XVEC iinput[] = { { { { 1.4f, 2.4f, 3.4f, 4.4f } } }, { { { 5.4f, 6.4f, 7.4f, 8.4f } } }, { { { 9.4f, 10.4f, 11.4f, 12.4f } } }, { { { 13.4f, 14.4f, 15.4f, 16.4f } } },
...
int main()
{
    ...
    if ( !FFTInterleavedTest() )
        return -1;

    if ( !IFFTDeinterleavedTest() )
        return -1;
